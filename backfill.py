...
# 직함('산업장관')과 기관장 이름은 기관명이 아니라 DUTY_KEYWORDS에 넣을 성질이 아니고,
# 넣어봐야 수집량은 거의 안 는다 — 네이버가 본문까지 훑으므로 그 기사는 이미
# 부처명으로 잡힌다. 다만 제목에 부처명이 없어 '본문 언급' 칸에 묻히는 게 문제라,
# 여기 넣어 '확실' 칸으로 올린다. 동명이인 노이즈도 안 생긴다(이미 수집된 것만 승격).
#
# ⚠️ 기관장 이름은 개각·인사 때마다 낡는다. 낡아도 오류가 안 나고 조용히
#    승격이 멈출 뿐이라 알아채기 어렵다. 아래 '확인일'을 갱신하며 관리할 것.
#    확인일: 2026-08-21
TITLE_ALIASES = {
    "산업부":     ["산업장관", "산업통상장관", "김정관"],
    "중기부":     ["중기장관", "중소벤처기업장관"],
